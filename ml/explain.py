...
def generate_shap_bar_plot(
    model_artifacts: dict[str, Any],
    X: np.ndarray,
    output_path: str = 'data/figures/shap_importance_bar.png',
) -> None:
    """
    Generates a bar plot of mean absolute SHAP values (global importance).
    ...
    logger.info("SHAP bar plot saved to %s", output_path)
